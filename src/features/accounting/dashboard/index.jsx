...
<button className="px-4 py-2 rounded-lg text-sm font-semibold bg-surface-container-lowest text-primary shadow-sm">Tháng</button>
<button className="px-4 py-2 rounded-lg text-sm font-semibold text-secondary hover:text-on-background">Quý</button>
<button className="px-4 py-2 rounded-lg text-sm font-semibold text-secondary hover:text-on-background">Năm</button>
</div>
...
<button className="flex items-center gap-2 bg-surface-container-highest text-on-surface px-5 py-3 rounded-xl text-sm font-bold hover:bg-surface-container-high transition-colors">
<span className="material-symbols-outlined text-sm" data-icon="download">download</span>
                        Export Excel
                    </button>
<button className="flex items-center gap-2 bg-secondary text-on-secondary px-5 py-3 rounded-xl text-sm font-bold hover:bg-secondary-dim transition-colors">
